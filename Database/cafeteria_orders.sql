...
CREATE TABLE `orders` (
  ...
  KEY `empID` (`empID`),
  KEY `prodID` (`prodID`),
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`empID`) REFERENCES `emp` (`EmpID`),
  CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`prodID`) REFERENCES `products` (`productID`)
...
-- Dump completed on 2022-09-06 10:05:20
