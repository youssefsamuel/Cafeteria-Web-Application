...
namespace Cafeteria.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetEmployee(string email, string pass) // Get an employee from the database given his email and password.
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] Employee employee) // Add a new employee to the database.
        {
            await Db.Connection.OpenAsync();
            employee.Db = Db;
            try
